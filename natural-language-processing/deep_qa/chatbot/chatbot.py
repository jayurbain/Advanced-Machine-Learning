...
"""
chatbot.py
Modified 6/22/2018 by Jay Urbain, jay.urbain@gmail.com 
to include methods for Telegram Chatbot integration.

Entry point for TelecomChatBot for Advanced NLP 
Open QA chatbot session
def telecomChatBotSessionOpen(self, args=None)

Issue telecom chatbot query
def telecomChatBotSessionQuery(self, question)

Close telecom chatbot session
...
#from chatbot.model_attention import Model
#from chatbot.model_attention import AttentionModel
...
class Chatbot:
    ...
    def parseArgs(args):
        ...
        parser.add_argument('--token', type=str, default='Telecom token')
    ...
    ########################################################################
    # Entry point for TelecomChatBot for Advanced NLP - jay.urbain@gmail.com
    # Open QA chatbot session
    def telecomChatBotSessionOpen(self, args=None):
        """
        Launch the training and/or the interactive mode
    ...
    # Issue telecom chatbot query - jay.urbain@gmail.com
    def telecomChatBotSessionQuery(self, question):
        questionSeq = []  # Will be contain the question as seen by the encoder
        answer = self.singlePredict(question, questionSeq)
        s = self.textData.sequence2str(answer, clean=True)
        print("Query:", question, answer, s) 
        return s

    # Close telecom chatbot session - jay.urbain@gmail.com
    def telecomChatBotSessionClose(self, question):
            self.sess.close()
            print("The End! Thanks for using this program")
